...
class SacdAgent(BaseAgent):
    ...
    def __init__(self, state_dim, n_actions, log_dir, num_steps=100000, batch_size=64,
                 lr=0.0003, memory_size=100000, gamma=0.99, multi_step=1,
                 target_entropy_ratio=0.98, start_steps=100,
                 update_interval=4, target_update_interval=100,
                 use_per=False, dueling_net=False, num_eval_steps=125000,
                 max_episode_steps=27000, log_interval=10, eval_interval=1000,
                 cuda=True, seed=0):
        super().__init__(
            state_dim, n_actions, log_dir, num_steps, batch_size, memory_size, gamma,
        ...
        self.target_entropy = \
            -np.log(1.0 / n_actions) * target_entropy_ratio
